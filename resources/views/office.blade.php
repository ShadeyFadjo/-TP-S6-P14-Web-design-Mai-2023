            ...
            <div id="layout-wrapper">
                ...
                <div class="main-content">
                    <div class="page-content">
                        ...
                        <h1> L'IA-MAZING (Tongasoa IA-dmin)</h1>


                        <h2><a href="{{ url('/liste') }}">Voir les IA-rticles</a></h2>
                                        ...
                                        <h2>Ajout nouvel IA-rticle :</h2>
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-label">Résumé de l'IA-rticle</label>
                                                        <textarea data-parsley-type="alphanum" name="resume" type="text"
                                                            class="form-control" 
                                                            ></textarea>
                                                   
                                                    <br/>
                                                    <label class="form-label">Contenu de l'IA-rticle </label>
                                                    <textarea placeholder="N'hésitez pas à utiliser les balises html (h1,h2,p,a ...) pour rédiger votre article (utilisation de ckeditor)" rows="10" cols="70" name="content" id="editor"></textarea>
